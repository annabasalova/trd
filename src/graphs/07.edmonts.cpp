//Дан неориентированный невзвешенный граф G с n вершинами. Требуется найти в нём наибольшее паросочетание, 
//т.е. такое наибольшее (по мощности) множество m его рёбер, что никакие два ребра из выбранных не инцидентны друг другу.
